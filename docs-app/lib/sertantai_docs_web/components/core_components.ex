defmodule SertantaiDocsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SertantaiDocsWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SertantaiDocsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SertantaiDocsWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  @doc """
  Renders a documentation navigation sidebar.
  """
  ...
  @doc """
  Renders a documentation content area with prose styling.
  """
  attr :class, :string, default: ""
  slot :inner_block, required: true
      ...
      <ol class="flex items-center space-x-2">
        <%= for {item, index} <- Enum.with_index(@items) do %>
          <li class="flex items-center">
            <%= if index > 0 do %>
              <.icon name="hero-chevron-right" class="w-4 h-4 text-gray-400 mx-2" />
            <% end %>
  ...
  @doc """
  Renders a documentation page header with title and description.
  """
  attr :title, :string, required: true
  ...
  def doc_header(assigns) do
    ~H"""
    <header class={["border-b border-gray-200 pb-6 mb-8", @class]}>
      <%= if @category do %>
        <div class="mb-2">
