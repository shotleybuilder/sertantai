defmodule SertantaiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SertantaiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SertantaiWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  ## Examples
      ...
      <.search_box placeholder="Search records..." name="search" value={@search} />
  """
